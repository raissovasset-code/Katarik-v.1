...
if (!['classic', 'elimination', 'pogoni'].includes(mode)) throw new Error('Unsupported mode');
if (!Number.isInteger(games) || games <= 0) throw new Error('--games must be positive');
if (!Number.isInteger(players) || players < 2 || players > 11) throw new Error('--players must be 2–11');
